...
function findPath(world, pathStart, pathEnd)
{
	...
	*/
	...
	function calculatePath()
	{
		...
		var	mypathStart = Node(null, {x:pathStart.Field0, y:pathStart.Field1});
		var mypathEnd = Node(null, {x:pathEnd.Field0, y:pathEnd.Field1});
